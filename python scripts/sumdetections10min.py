...
Result = client.query('select sum(PIR) from "motionsensor5min"."autogen"."sensor" ' 'where WDay=$day ' 'and Time_index >=$Time_index_min ' 'and Time_index<=$Time_index_max ', params={"params":json.dumps(params)})
